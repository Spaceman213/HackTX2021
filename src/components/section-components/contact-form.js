		            ...
		            <div className="row">
		              <div className="col-lg-6 col-md-6 col-12">
		                <div className="single-input-wrap input-group">
		                  <input name="name" type="text" className="form-control" placeholder="Token Name" />
		              ...
		              <div className="col-lg-6 col-md-6 col-12">
		                <div className="single-input-wrap input-group">
		                  <input type="email" name="email" className="form-control" placeholder="Token Quantity" />
		                  <div className="input-group-prepend">
		              ...
		              <div className="col-12">
		                <div className="single-input-wrap input-group">
		                  <textarea className="form-control" name="message" rows={1} name="note" placeholder="Description" defaultValue={""} />
		                  <div className="input-group-prepend">
		                ...
		                <div className="submit-area text-center">
		                  <button type="submit" className="btn btn-base" id = "a5">START MINTING </button>
		                </div>
		              </div>
		            </div>
		          </form>
